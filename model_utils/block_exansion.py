...
from model_utils.drop_path import DropPath
from model_utils.layer_scale import LayerScale
import torch
import copy


def expand_dinov2(backbone, block_expansion_positions: list[int], block_expansion_path_dropout: float = 0.0):
    '''
...
def get_expanded_block_positions(original_positions: list[int]):
